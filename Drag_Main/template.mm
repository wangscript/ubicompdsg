...
void templateLoading( void ) {
	...
	CFURLRef win1 = (CFURLRef)[ [NSURL alloc] initFileURLWithPath: [[NSBundle mainBundle] pathForResource: @"win1" ofType:@"wav" ]];
	AudioServicesCreateSystemSoundID( win1, &soundID2);	
