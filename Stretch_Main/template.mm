	...
	if( _SIO2camera )
	{
		...
		if ( render3DObjects ){
			...
			if (taskType[taskState - 1] == 2){
				...
				RenderTransparentObject(objectSelect2);
				
			}
			else if( taskState == 0 || taskType[taskState - 1] == 1)
			{
				RenderTransparentObject(objectSelect);
			}
			...
			{
				RenderTransparentObject( frontVisual[index] );
			}
